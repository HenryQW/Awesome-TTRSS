...
默认使用 `wangqiru/ttrss:latest` 版本，该版本包含了 [TTRSS 官方](https://git.tt-rss.org/fox/tt-rss/releases)的稳定发行版。 `wangqiru/ttrss:nightly` 包含了最新为发行版，可能包含 bug。旧版本请参照 [此页面](https://cloud.docker.com/repository/docker/wangqiru/ttrss/tags)。
